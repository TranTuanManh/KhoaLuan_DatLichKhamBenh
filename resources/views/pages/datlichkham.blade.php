							...
							<div class="your-order-body" style="padding: 0px 10px">
										...
										<div class="your-order-item">
											<div class="form-block">
												...
												<input class="form-control" type="date" name="ngayhen" style="margin-left: 50px;">		
											</div>
											<div class="clearfix"></div>
										</div>
										...
										<div class="your-order-item" style="background-color: #e1e3e6">
											<div class="form-block">
												...
												<span style="margin-left: 75px;" id="address-doctor" name="address-doctor"></span>	
											</div>
											<div class="clearfix"></div>
										</div>
										...
										<div class="your-order-item" style="background-color: #e1e3e6">
											<div class="form-block">
												...
												<span style="margin-left: 95px;" id="department"></span>	
											</div>
											<div class="clearfix"></div>
										</div>
